// PDHD per-event pattern-recognition job (539 TLA defaults = the PDHD operating point) -- THIN RE-EXPORT.
//
// The implementation now lives in the canonical, in-tree job
//   cfg/pgrapher/experiment/pdhd/wct-pr-perevt.jsonnet
...
import 'pgrapher/experiment/pdhd/wct-pr-perevt.jsonnet'

# Your task: a verdict-blind scan of five PDHD items (doc pdhd/19 §8, rubric v5)
...
`/home/xqian/tmp/h20/RUBRIC.md` (rubric **v5**)
...
1. **Read only** the rubric, this file, your item list, and
   ...
   * **Never open anything under `/home/xqian/tmp/h18/` or
     `/home/xqian/tmp/h19/`.** Those are the earlier scans of these same items.
     `<SHOTS>` links into h19's frames. Read the frames through `<SHOTS>` only,
     and do not list or open anything else in h19.
   * Under `/home/xqian/tmp/h20/`, open only `RUBRIC.md`, this file, `shots/`,
...
* `<SHOTS>` = `/home/xqian/tmp/h20/shots`

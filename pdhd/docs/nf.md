...
| `lf_loose_filter` | `nf.jsonnet` `data.lf_loose_filter` | `'ROI_loose_lf'` | SP `LfFilter` instance for `Subtract_WScaling` (per-channel ROI deconvolution pass; τ=0.003 MHz). Replaces the old `filter_low_loose`. |

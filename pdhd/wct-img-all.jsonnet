// PDHD standalone imaging job over SP frames -- THIN RE-EXPORT.
//
// The implementation now lives in the canonical, in-tree job
//   cfg/pgrapher/experiment/pdhd/wct-img-all.jsonnet
...
import 'pgrapher/experiment/pdhd/wct-img-all.jsonnet'

...
#
#   ./retire_20260916.sh 1 [tree ...]
#   CONFIRM=yes ./retire_20260916.sh 1 pdvd
#
# Fork of retire_20260910.sh; the keep test is doc 104's, unchanged (see
# plan_20260916.py's header).  THE ORDER IS NOT OPTIONAL:
#     1. python3 archive_records_20260916.py 1     freeze the record layer (M13)
...
# counts against what plan_20260916.py printed before typing CONFIRM=yes.
set -u
D="$(cd "$(dirname "$0")" && pwd)"
STAMP=20260916
...
echo "count per tree (prebroken_<tree>_20260916.txt); this number only means"

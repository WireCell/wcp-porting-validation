...
"""Emit every token an arm dir can legitimately be cited BY.
  ...
  usage:  python3 toks_20260916.py     # writes toks_20260916.txt (flat) + toks_20260916.json (per dir)

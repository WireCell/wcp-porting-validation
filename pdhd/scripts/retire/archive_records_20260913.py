...
"""Freeze the RECORD LAYER of every arm the 2026-09-06 round releases.
  ...
  usage:  python3 archive_records_20260913.py 1        # tier 1
          python3 archive_records_20260913.py 2        # tier 2
...
if __name__ == "__main__":
    ...
    if not jobs: sys.exit("nothing to archive -- run plan_20260913.py first")
    done = 0

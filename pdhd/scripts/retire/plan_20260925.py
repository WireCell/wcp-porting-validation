...
file-level lever -- "Both" (plan_files_20260925.py); (4) PDVD -- the ToT Q/L scan sources,
...
Fork of plan_20260921b.py.  What THIS round changes (all in TREES below):
  ...
  5. LIVENESS pins remote_head_20260925.txt = 07ae168f, verified by ls-remote over https.
...
plan_20260919.py; what THIS round changes:
  ...
  6. LIVENESS pins remote_head_20260925.txt = f04d8937, VERIFIED equal to the remote by
...
TREES = {
 "sbnd": dict(
   ...
   # `pr150s0` is NOT production any more -- it stays as the SENTINEL REFERENCE: the suite passes
   # 21/0/2/7 on it and 13 PASS / 9 FAIL on the d123 arms (not re-baselined; several FAILs are
   # seg-id log strings).  Re-baseline the suite on d123 and it can go (doc 125 carry-forward).
   production=["d123lgop","d123lgoppr","d123lgflip","d123lgflipoff","d123lgflippr","pr150s0"],
   scan_arms=[],

...
"""Emit every token an arm dir can legitimately be cited BY.
  ...
  usage:  python3 toks_20260912.py     # writes toks_20260912.txt (flat) + toks_20260912.json (per dir)

...
"""Emit every token an arm dir can legitimately be cited BY.
  ...
  usage:  python3 toks_20260919.py     # writes toks_20260919.txt (flat) + toks_20260919.json (per dir)

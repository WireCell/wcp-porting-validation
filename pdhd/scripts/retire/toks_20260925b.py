...
"""Emit every token an arm dir can legitimately be cited BY.
  ...
  usage:  python3 toks_20260925b.py     # writes toks_20260925b.txt (flat) + toks_20260925b.json (per dir)

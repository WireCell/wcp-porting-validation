...
"""Emit every token an arm dir can legitimately be cited BY.
  ...
  usage:  python3 toks_20260916d.py     # writes toks_20260916d.txt (flat) + toks_20260916d.json (per dir)

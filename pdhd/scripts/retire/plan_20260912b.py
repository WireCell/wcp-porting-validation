...
plan_20260910.py; what THIS round changes:
  ...
  3. THE HAND-SCAN SET GREW, and half of it has no prep set.  smx5..smx9
     ...
     09-10.  scan_arms_20260912b.py now also reads docs/scan records, because
...
G = "the owner released the undocumented master-merge validation round by name on 2026-09-12 (doc 105 sec 13); its ~/tmp/mg10 record layer is frozen in cleanup-20260912b/tmp-tier1"
...
TREES = {
 "sbnd": dict(
   ...
   uncited_ok={"mg10a": G, "mg10a2": G, "mg10a2pr": G, "mg10b": G, "mg10b2": G, "mg10b2pr": G},
   tier2={}, tier3={}, tier4={},
 ),
 ...
 "pdvd": dict(
   ...
   substrate=["d51vclus","keep","d27fresh","d41prov","d39r2prov","d143pnew",
              "d28dlfp","d34base","d48nu7","d11vtrace","d16vnu",
              "d31r6e2e","(bare)"],

...
"""Freeze the ~/tmp units of cleanup ROUND D (doc sbnd_xin/111) before they are removed.
  ...
  usage:  python3 archive_tmp_20260919.py tmp_tier_20260919.txt
...
Output: $RETIRE_OUT (default sbnd_xin/archive/records/cleanup-20260919/tmp).
...
OUT   = os.environ.get("RETIRE_OUT", f"{R}/sbnd/sbnd_xin/archive/records/cleanup-20260919/tmp")
...
if __name__ == "__main__":
    tier = sys.argv[1] if len(sys.argv) > 1 else sys.exit("usage: archive_tmp_20260919.py <tier file>")

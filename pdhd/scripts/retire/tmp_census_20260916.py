...
"""Cleanup ROUND D 2026-09-16 (doc sbnd_xin/111): the ~/tmp census.  Retires nothing.
  ...
  usage:  python3 tmp_census_20260916.py            # report + tmp_tier_20260916.txt
          python3 tmp_census_20260916.py --list     # print the tier only

Run AFTER plan_20260916.py: "alive" is what survives the work release, read from
its tier1_*_20260916.txt files, not what is on disk now.
...
LIVE_TOP = ("d111", "d112", "d113", "d103", "d108")
...
NOT_ROUNDS = {"claude-25225", "cleanup-20260916"}

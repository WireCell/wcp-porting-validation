...
"""Cleanup ROUND D 2026-09-16 (doc sbnd_xin/111): the ~/tmp census.  Retires nothing.
  ...
  usage:  python3 tmp_census_20260919.py            # report + tmp_tier_20260919.txt
          python3 tmp_census_20260919.py --list     # print the tier only

Run AFTER plan_20260919.py: "alive" is what survives the work release, read from
its tier1_*_20260919.txt files, not what is on disk now.
...
NOT_ROUNDS = {"claude-25225", "cleanup-20260919"}

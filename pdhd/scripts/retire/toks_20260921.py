...
"""Emit every token an arm dir can legitimately be cited BY.
  ...
  usage:  python3 toks_20260921.py     # writes toks_20260921.txt (flat) + toks_20260921.json (per dir)

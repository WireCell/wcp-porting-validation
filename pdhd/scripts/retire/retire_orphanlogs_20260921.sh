...
# plan_orphanlogs_20260921.py's header for why the directory planner cannot see them and
# why this is NOT the file-level release of round D sec 14.
#
# ORDER: plan_20260921.py (its keep list is an input) -> plan_orphanlogs_20260921.py ->
#        archive_orphanlogs_20260921.py -> this.
...
#   6   the record dir is missing -- run archive_orphanlogs_20260921.py first

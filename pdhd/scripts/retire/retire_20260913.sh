#!/bin/bash
# Cleanup ROUND C 2026-09-13 (doc 106) -- deletion driver.  DRY RUN unless CONFIRM=yes.
...
#
#   ./retire_20260913.sh 1 [tree ...]
#   CONFIRM=yes ./retire_20260913.sh 1 pdvd
#
# Fork of retire_20260910.sh; the keep test is doc 104's, unchanged (see
# plan_20260913.py's header).  THE ORDER IS NOT OPTIONAL:
#     1. python3 archive_records_20260913.py 1     freeze the record layer (M13)
...
# counts against what plan_20260913.py printed before typing CONFIRM=yes.
set -u
D="$(cd "$(dirname "$0")" && pwd)"
STAMP=20260913
...
echo "count per tree (prebroken_<tree>_20260913.txt); this number only means"

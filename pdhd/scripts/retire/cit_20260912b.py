...
"""Token-boundary citation census over ALL trees' docs / scripts / labels / displays.
  ...
  usage:  python3 toks_20260912b.py            # writes toks.txt + toks.json
          python3 cit_20260912b.py toks.txt cit_20260912b.json
...
ROOTS = [f"{R}/pdhd/docs", f"{R}/pdhd/scripts", f"{R}/pdhd/stm_scan", f"{R}/pdhd/ql_scan",
         f"{R}/pdhd/stm_michel_scan", f"{R}/pdhd/stm_michel_scan/prep-pdvd",
         f"{R}/pdhd/stm_michel_scan/prep-pdvd-smx3", f"{R}/pdhd/stm_michel_scan/prep-pdvd-smx4",
         f"{R}/pdhd/stm_michel_scan/prep-pdhd",

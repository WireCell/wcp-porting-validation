#!/usr/bin/env python3
"""
Cleanup ROUND I 2026-09-21 -- planner for sbnd_xin + pdvd + pdhd.  Doc sbnd_xin/121.
...
plan_20260919.py; what THIS round changes:
  ...
  6. LIVENESS pins remote_head_20260921.txt = f04d8937, VERIFIED equal to the remote by

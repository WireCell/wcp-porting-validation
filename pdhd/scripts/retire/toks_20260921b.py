...
"""Emit every token an arm dir can legitimately be cited BY.
  ...
  usage:  python3 toks_20260921b.py     # writes toks_20260921b.txt (flat) + toks_20260921b.json (per dir)

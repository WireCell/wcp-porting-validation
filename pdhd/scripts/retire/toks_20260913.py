...
"""Emit every token an arm dir can legitimately be cited BY.
  ...
  usage:  python3 toks_20260913.py     # writes toks_20260913.txt (flat) + toks_20260913.json (per dir)

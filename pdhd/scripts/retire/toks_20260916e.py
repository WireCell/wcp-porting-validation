...
"""Emit every token an arm dir can legitimately be cited BY.
  ...
  usage:  python3 toks_20260916e.py     # writes toks_20260916e.txt (flat) + toks_20260916e.json (per dir)

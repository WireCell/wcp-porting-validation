...
"""Emit every token an arm dir can legitimately be cited BY.
  ...
  usage:  python3 toks_20260925.py     # writes toks_20260925.txt (flat) + toks_20260925.json (per dir)

#!/usr/bin/env python3
"""Freeze the ~/tmp units of cleanup ROUND C (doc 106) before they are removed.

  usage:  python3 archive_tmp_20260913.py tmp_tier_20260913.txt
...
Output: $RETIRE_OUT (default sbnd_xin/archive/records/cleanup-20260913/tmp).
...
OUT   = os.environ.get("RETIRE_OUT", f"{R}/sbnd/sbnd_xin/archive/records/cleanup-20260913/tmp")
...
if __name__ == "__main__":
    tier = sys.argv[1] if len(sys.argv) > 1 else sys.exit("usage: archive_tmp_20260913.py <tier file>")

// PDHD standalone per-APA + all-APA clustering job -- THIN RE-EXPORT.
//
// The implementation now lives in the canonical, in-tree job
//   cfg/pgrapher/experiment/pdhd/wct-clustering.jsonnet
...
import 'pgrapher/experiment/pdhd/wct-clustering.jsonnet'

// PDHD SP frames -> Magnify ROOT converter -- THIN RE-EXPORT.
//
// The implementation now lives in the canonical, in-tree job
//   cfg/pgrapher/experiment/pdhd/wct-sp-to-magnify.jsonnet
...
import 'pgrapher/experiment/pdhd/wct-sp-to-magnify.jsonnet'

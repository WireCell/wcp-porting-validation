...
archive -- M2).  Both arms were produced by scripts/runners/run_perf54_nusel.sh under
...
Repro:
  cd sbnd_xin
  ./scripts/runners/run_perf54_nusel.sh base     # before the code change
  ./scripts/runners/run_perf54_nusel.sh opt      # after

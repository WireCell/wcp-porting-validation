...
STATE = os.environ.get("RETIRE_STATE", os.path.join(SCR, "state-20260825"))
...
KEEP_WHY = {
    # --- campaign INPUT, 8 ------------------------------------------------
    'work-img-nuecc48':      'imaging hub, 48 evts; doc 81 stage-A gate reference',
    'work-img-ncpi0':        'imaging hub, 19 evts; doc 81 stage-A gate reference',
    'work-img-mcp1k':        'imaging hub, 1000 evts; doc 81 stage-A gate reference',
    'work-img-mcp2k':        'imaging hub, 2000 evts; doc 81 stage-A gate reference',
    ...
    # --- Q/L reference the doc 81 stage-A gate is taken against, 4 ---------
    'work-nuecc48-ql0819':   'Q/L reference for doc 81 stage A (384/384 identical)',
    'work-ncpi0-ql0819':     'Q/L reference for doc 81 stage A (152/152)',
    'work-mcp1k-ql0819':     'Q/L reference for doc 81 stage A (8000/8000)',
    'work-mcp2k-ql0819':     'Q/L reference for doc 81 stage A (16000/16000)',
    ...
    # --- the PRE-flip PR record, 4 ----------------------------------------
    # NOT superseded by prod0825: the only on-disk product at the pre-flip
    # config (no dl_vtx_dual_chain/snapD2, no fast_xgb_forest).  PROTECTED.txt.
    'work-nuecc48-prod0823': 'PRE-flip PR baseline, 48 evts; PROTECTED.txt',
    'work-ncpi0-prod0823':   'PRE-flip PR baseline, 19 evts',
    'work-mcp1k-prod0823':   'PRE-flip PR baseline, 1000 evts',
    'work-mcp2k-prod0823':   'PRE-flip PR baseline, 2000 evts',
...
PR_PROVENANCE = {
    ...
    'work-nuecc48-prod0823': 'work-nuecc48-ql0819',
    'work-ncpi0-prod0823':   'work-ncpi0-ql0819',
    'work-mcp1k-prod0823':   'work-mcp1k-ql0819',
    'work-mcp2k-prod0823':   'work-mcp2k-ql0819',
...
CAMPAIGN_OUT = {
    ...
    'work-nuecc48-prod0823': ('pr_evt',   48), 'work-ncpi0-prod0823': ('pr_evt',   19),
    'work-mcp1k-prod0823':   ('pr_evt', 1000), 'work-mcp2k-prod0823': ('pr_evt', 2000),
...
# ---------------------------------------------------------------- emit
with open(os.path.join(SCR, "tierA_20260825.txt"), "w") as fh:
    fh.write("\n".join(sorted(TA)) + "\n")
...
print(f"\nremoval set: {len(R)} dirs -> scripts/retire/tierA_20260825.txt")

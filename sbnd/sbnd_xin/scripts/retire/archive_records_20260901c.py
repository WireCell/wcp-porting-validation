...
state-20260901c/group-dupes.tsv.  Run that first; the driver's interlock 4
...
Output tree archive/records/campaign-close-20260901c/<group>/.  Never writes into an
...
OUT = os.environ.get("RETIRE_OUT",
                     os.path.join(ROOT, "archive", "records", "campaign-close-20260901c"))

...
state-20260831b/group-dupes.tsv.  Run that first; the driver's interlock 4
...
SCR = os.environ.get("RETIRE_STATE",
                     os.path.join(ROOT, "scripts", "retire", "state-20260831b"))
...
if __name__ == "__main__":
    ...
    print(f"  of which the new groupin class dropped {tot_gin/2**30:.2f} GiB "
          f"(proven duplicates, state-20260831b/group-dupes.tsv)")

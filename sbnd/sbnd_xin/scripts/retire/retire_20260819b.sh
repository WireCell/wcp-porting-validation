...
#
#   ./retire_20260819b.sh A              # dry run (default action)
#   CONFIRM=yes ./retire_20260819b.sh A  # actually delete
#
...
STATE=$BASE/scripts/retire/state-20260819b
REC=$BASE/archive/records/prod0819-era-20260819b
TIERS=${1:-A}
CONFIRM=${CONFIRM:-no}
...
tierfiles=""
for t in ${TIERS//,/ }; do
    f=$BASE/scripts/retire/tier${t}_20260819b.txt
...
if [ "$CONFIRM" = yes ]; then
    {
      echo "# retire_20260819b.sh  tiers=$TIERS"

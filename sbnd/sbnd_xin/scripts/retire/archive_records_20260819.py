...
Output tree archive/records/pr40-94-era-20260819/<group>/.  Never writes into
...
SCR = os.environ.get("RETIRE_STATE",
                     os.path.join(ROOT, "scripts", "retire", "state-20260819"))
OUT = os.environ.get("RETIRE_OUT",
                     os.path.join(ROOT, "archive", "records", "pr40-94-era-20260819"))

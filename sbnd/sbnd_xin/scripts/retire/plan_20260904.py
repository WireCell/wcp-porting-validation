...
RETIRE_LABELS = [
    # doc 92 epoch gate -- superseded by d99fix on the same 308-event manifest
    "d92gate", "d92gatepr",
    # doc 99 round 1 (flash_at range guard) -- superseded by round 2's six arms
    "d99fix", "d99fixpr",
    # doc 99 round 2 -- superseded by round 3, which SHIPPED both knobs.
    # NOTE d99r2wr / d99r2bothpr are the SOURCE side of round 3's flip gate
    # (d99r3prod == d99r2wr, d99r3prodpr == d99r2bothpr).  A gate's source arm
    # is part of the record, so archive_records freezes their member hashes
    # BEFORE this list is acted on -- INTERLOCK 8 refuses the round otherwise.
    "d99r2off", "d99r2offpr", "d99r2rdpr",
    "d99r2wr", "d99r2wrpr", "d99r2bothpr", "d99r2smoke",
    # doc 95 debug-25 scan set (dbg25a/dbg25b -- NOT the pdvd doc-25 family)
    "dbg25a-ql", "dbg25a-pr", "dbg25a-d97fv", "dbg25a-d97off", "dbg25a-d97on",
    "dbg25a-d97fvpr", "dbg25a-d97fvpr3", "dbg25a-d97offpr", "dbg25a-d97onpr",
    "dbg25a-trace95", "dbg25a-sepcensus95", "dbg25a-sepdbg95",
    # NOT dbg25a-d97prodchk: PROTECTED.txt pins it as part of doc 97 sec 9's
    # "production default == the validated arm" set (INTERLOCK 5 caught it).
    "dbg25b-ql", "dbg25b-pr", "dbg25b-d97fv", "dbg25b-d97off", "dbg25b-d97on",
    "dbg25b-d97fvpr3", "dbg25b-d97offpr", "dbg25b-d97onpr", "dbg25b-sepcensus95",
    # doc 93/94 STM feedback 8-event set -- doc 94 CLOSED, both rescues shipped
    "stmfb8-ql", "stmfb8-pr", "stmfb8-probe", "stmfb8-negctl",
    "stmfb8-hadron", "stmfb8-hadronfit", "stmfb8-stmfit",
    "stmfb8-r2on", "stmfb8-r2negctl", "stmfb8-r2probe",
    "stmfb8-r2scanon", "stmfb8-r2scanoff", "stmfb8-r3chk", "stmfb8-r3on",
    # doc 91 negative controls -- the suite was re-baselined and is RED on each
    "91neg-sccc", "91neg-scccgap", "91neg-backdvtx", "91neg-backguard",
    "91neg-gfimpact", "91neg-prune2", "91neg-p3cone",
    # doc 94 round-2 scan pair
    "r2scanon", "r2scanoff",
]
# RETIRE_EXTRA is empty this round.  work-probe178410a was listed and INTERLOCK
# 5 refused it: PROTECTED.txt calls it the ONLY on-disk proof that mcp2k evt
# 178410's SIGSEGV is nondeterministic, and a nondeterministic crash cannot be
# re-captured on demand.  17 MB.  Left alone.
RETIRE_EXTRA = []
...
busy_proc = [l for l in ps.splitlines()
             ...
             and ROOT in l
             and not re.search(r"grep|plan_20260904", l)]
time.sleep(20)
...
recdir = os.path.join(ROOT, "archive", "records", "campaign-close-20260904")
frozen = set()

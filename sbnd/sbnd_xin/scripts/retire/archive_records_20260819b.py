...
Output tree archive/records/prod0819-era-20260819b/<group>/.  Never writes into
...
SCR = os.environ.get("RETIRE_STATE",
                     os.path.join(ROOT, "scripts", "retire", "state-20260819b"))
OUT = os.environ.get("RETIRE_OUT",
                     os.path.join(ROOT, "archive", "records", "prod0819-era-20260819b"))

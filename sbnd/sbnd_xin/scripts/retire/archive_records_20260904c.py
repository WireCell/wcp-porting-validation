#!/usr/bin/env python3
"""Archive the record layer of the 2026-09-04 retiring arms (doc 100) -- the
doc 92 -> doc 99 gate chain, doc 95's debug-25 set, doc 93/94's stmfb8 set and
doc 91's negative controls.

Fork of archive_records_20260902.py by verbatim `cp` (cmp-verified before
...
Output tree archive/records/campaign-close-20260904c/<group>/.  Never writes
...
SCR = os.environ.get("RETIRE_STATE",
                     os.path.join(ROOT, "scripts", "retire", "state-20260904c"))
OUT = os.environ.get("RETIRE_OUT",
                     os.path.join(ROOT, "archive", "records", "campaign-close-20260904c"))

...
Writes scripts/retire/tierA_20260823.txt and state-20260823/plan.json.
...
STATE = os.environ.get("RETIRE_STATE", os.path.join(SCR, "state-20260823"))
...
KEEP_WHY = {
    # --- campaign INPUT, 8 ------------------------------------------------
    'work-img-nuecc48':      'imaging hub, 48 evts; the re-run campaign and run_valfast.sh both pin it',
    'work-img-ncpi0':        'imaging hub, 19 evts',
    'work-img-mcp1k':        'imaging hub, 1000 evts; ql0819 evt<N> links resolve here',
    'work-img-mcp2k':        'imaging hub, 2000 evts; ql0819 evt<N> links resolve here',
    'work-img-r1qlmc':       'imaging hub; only copy of this sim sample',
    'work-img-r2mc':         'imaging hub; only copy of this sim sample',
    'work-r1qlmc-cb0805':    'SIM Q/L hub; ASSERT 8 input to work-r1qlmc-prod0813 (the data cb0805 hubs are RELEASED this round)',
    'work-r2mc-cb0805':      'SIM Q/L hub; ASSERT 8 input to work-r2mc-prod0813',
    # --- latest production QLMatching, 4 ----------------------------------
    'work-nuecc48-ql0819':   'latest production Q/L, 48 evts, bare at toolkit fd6a116d; INPUT to the 2026-08-23 PR re-run',
    'work-ncpi0-ql0819':     'latest production Q/L, 19 evts; INPUT to the re-run',
    'work-mcp1k-ql0819':     'latest production Q/L, 1000 evts; INPUT to the re-run',
    'work-mcp2k-ql0819':     'latest production Q/L, 2000 evts; INPUT to the re-run',
    # --- latest production PR (pr/104 epoch), 8 ---------------------------
    'work-pr104-on4-nuecc48':  'current-production PR product (junction snap ON), 48 evts',
    'work-pr104-on4-ncpi0':    'current-production PR product, 19 evts',
    'work-pr104-on4-mcp1k':    'current-production PR product, 1000 evts',
    'work-pr104-on4-mcp2k':    'current-production PR product, 15-evt mcp2k subset -- the gap the re-run closes',
    'work-pr104-flipchk-nuecc48': 'post-flip BARE run (no env) == on4; the only on-disk shipped-config proof, 48 evts',
    'work-pr104-flipchk-ncpi0':   'post-flip BARE run == on4, 19 evts',
    'work-pr104-flipchk-mcp1k':   'post-flip BARE run == on4, 26-evt subset',
    'work-pr104-flipchk-mcp2k':   'post-flip BARE run == on4, 15-evt subset',
    # --- the current vertex-label epoch, 4 --------------------------------
    'work-vtx105-base-nuecc48': 'calib-pr dumps behind the vtxscan-vtx105-* label epoch, 47 evts (owner kept)',
    ...
    # --- doc pr/111 (OPEN round) live inputs, 2 ---------------------------
    'work-vtx106-harv-base-nuecc48':   'fit_exclusion ON arm hardcoded by scripts/pr111_{brittle,ensemble,dl_decomp,rival,rival_where}.py',
    'work-vtx106-harv-nofitx-nuecc48': 'fit_exclusion OFF arm hardcoded by the same five pr/111 scripts',
    'work-vtx106-cne-on-nuecc48':      "the pr/106 sec.10 dl_vtx_cloud_no_exclusion pair, listed in doc pr/111's own arm table (open round)",
    'work-vtx106-cne-off-nuecc48':     'the OFF leg of that pair; the ncpi0 legs are NOT in the pr/111 table and are released',
    ...
    'work-probe178410a':     'the ONLY proof mcp2k evt 178410 SIGSEGV is non-deterministic (rc=0/683 MB at -j 1 vs rc=139/2403 MB at -j 32); 6.7 MB',
}
KEEP = set(KEEP_WHY)
...
PR_PROVENANCE = {
    'work-pr104-on4-nuecc48':          'work-nuecc48-ql0819',
    'work-pr104-on4-ncpi0':            'work-ncpi0-ql0819',
    'work-pr104-on4-mcp1k':            'work-mcp1k-ql0819',
    'work-pr104-on4-mcp2k':            'work-mcp2k-ql0819',
    'work-pr104-flipchk-nuecc48':      'work-nuecc48-ql0819',
    'work-pr104-flipchk-ncpi0':        'work-ncpi0-ql0819',
    'work-pr104-flipchk-mcp1k':        'work-mcp1k-ql0819',
    'work-pr104-flipchk-mcp2k':        'work-mcp2k-ql0819',
    ...
    'work-vtx106-harv-base-nuecc48':   'work-nuecc48-ql0819',
    'work-vtx106-harv-nofitx-nuecc48': 'work-nuecc48-ql0819',
    'work-vtx106-cne-on-nuecc48':      'work-nuecc48-ql0819',
    'work-vtx106-cne-off-nuecc48':     'work-nuecc48-ql0819',
...
if len(R) > 25:
    print(f"    ... and {len(R)-25} more (full list: tierA_20260823.txt)")
...
CAMPAIGN_OUT = {
    'work-nuecc48-ql0819': ('ql_evt',   48), 'work-ncpi0-ql0819':  ('ql_evt',   19),
    'work-mcp1k-ql0819':   ('ql_evt', 1000), 'work-mcp2k-ql0819':  ('ql_evt', 2000),
    'work-r1qlmc-vfcbr3on': ('ql_evt',  10), 'work-r2mc-vfcbr3on': ('ql_evt',  13),
    'work-pr104-on4-nuecc48':     ('pr_evt',  48),
    'work-pr104-on4-ncpi0':       ('pr_evt',  19),
    'work-pr104-on4-mcp1k':       ('pr_evt', 1000),
    'work-pr104-on4-mcp2k':       ('pr_evt',  15),
    'work-pr104-flipchk-nuecc48': ('pr_evt',  48),
    'work-pr104-flipchk-ncpi0':   ('pr_evt',  19),
    'work-pr104-flipchk-mcp1k':   ('pr_evt',  26),
    'work-pr104-flipchk-mcp2k':   ('pr_evt',  15),
    ...
    'work-vtx106-harv-base-nuecc48':   ('pr_evt', 47),
    'work-vtx106-harv-nofitx-nuecc48': ('pr_evt', 47),
    'work-vtx106-cne-on-nuecc48':      ('pr_evt', 47),
    'work-vtx106-cne-off-nuecc48':     ('pr_evt', 47),
    'work-r1qlmc-prod0813': ('pr_evt', 10), 'work-r2mc-prod0813': ('pr_evt', 13),
}
CAMPAIGN_INPUT = {
...
# ---------------------------------------------------------------- emit
with open(os.path.join(SCR, "tierA_20260823.txt"), "w") as fh:
    fh.write("\n".join(sorted(TA)) + "\n")
...
print(f"\nremoval set: {len(R)} dirs -> scripts/retire/tierA_20260823.txt")

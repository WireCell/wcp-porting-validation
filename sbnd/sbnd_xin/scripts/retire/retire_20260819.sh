...
#
#   ./retire_20260819.sh A              # dry run (default action)
#   CONFIRM=yes ./retire_20260819.sh A  # actually delete
#
...
STATE=$BASE/scripts/retire/state-20260819
REC=$BASE/archive/records/pr40-94-era-20260819
TIERS=${1:-A}
CONFIRM=${CONFIRM:-no}
...
tierfiles=""
for t in ${TIERS//,/ }; do
    f=$BASE/scripts/retire/tier${t}_20260819.txt
...
if [ "$CONFIRM" = yes ]; then
    {
      echo "# retire_20260819.sh  tiers=$TIERS"

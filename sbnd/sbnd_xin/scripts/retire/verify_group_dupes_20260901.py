...
Writes state-20260901/group-dupes.tsv (one row per group tar) and exits
...
STATE = os.environ.get("RETIRE_STATE",
                       os.path.join(ROOT, "scripts", "retire", "state-20260901"))
...
if __name__ == "__main__":
    ...
    if not jobs:
        ...
        with open(os.path.join(STATE, "group-dupes.tsv"), "w") as fh:
            fh.write("# verify_group_dupes_20260901.py: 0 .groups/g*.tar.gz in the\n"

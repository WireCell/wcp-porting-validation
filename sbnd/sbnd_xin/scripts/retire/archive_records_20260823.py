#!/usr/bin/env python3
"""Archive of the record layer of the 2026-08-23 retiring arms -- the
pr/96-111 sweep back to a minimal state at the latest production.

Fork of archive_records_20260819b.py.  HEAVY is carried unchanged: docs
pr/98-111 introduced no new per-event product class beyond what 08-13 already
classified (checked against work-vtx106-harv-base-nuecc48's and
work-pr109e-on-nuecc48's file lists -- the pr/108-109 debug dumps land in
/home/xqian/tmp, not inside the arm).  The integrity gate below still catches a
tar/manifest mismatch if a class was missed.

Output tree archive/records/prod0823-minimal-20260823/<group>/.  Never writes
...
SCR = os.environ.get("RETIRE_STATE",
                     os.path.join(ROOT, "scripts", "retire", "state-20260823"))
OUT = os.environ.get("RETIRE_OUT",
                     os.path.join(ROOT, "archive", "records", "prod0823-minimal-20260823"))

...
state-20260901/group-dupes.tsv.  Run that first; the driver's interlock 4
...
Output tree archive/records/campaign-close-20260901/<group>/.  Never writes into an
...
OUT = os.environ.get("RETIRE_OUT",
                     os.path.join(ROOT, "archive", "records", "campaign-close-20260901"))
...
if __name__ == "__main__":
    ...
    print(f"  of which the new groupin class dropped {tot_gin/2**30:.2f} GiB "
          f"(proven duplicates, state-20260901/group-dupes.tsv)")

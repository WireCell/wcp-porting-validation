#!/bin/bash
# pr/121+122 round 1 arms.  Usage: pr121_arms.sh <manifest 98|141> <armtag> <probes 0|1> [env assignments...]
...
for s in $SAMPLES; do
  ./run_pr_chain_batch.sh work-$s-grp0825 work-pr121r1-$TAG-$s data ${EV[$s]} > /home/xqian/tmp/pr121_${TAG}_$s.log 2>&1
  echo "arm $TAG-$s rc=$?"
done

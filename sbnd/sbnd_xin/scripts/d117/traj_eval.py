#!/usr/bin/env python3
"""doc sbnd_xin/117: the pr/150 trajectory-closure instrument on the doc-115 / doc-116 MC arms.
...
per-event nusel table, and the output goes to docs/117_figs/traj/<label>.tsv.
...
Usage:
  scripts/d117/traj_eval.py extract --arm-dir work-r3cv-d115pr --label cv-baseline [--jobs 16]
  scripts/d117/traj_eval.py compare --a cv-c2 --b cv-c1x
"""
import argparse
import csv
import glob
...
OUT = os.path.join(SX, "docs", "117_figs", "traj")

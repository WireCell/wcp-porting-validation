#!/usr/bin/env python3
"""doc pr/49: compare a fit_blob_coverage knob-ON arm vs its knob-off twin
(same binary, same events) -- archive movers, per-mover vertex diff, nusel
diffs (both granularities; nusel tsvs are WHITESPACE-separated despite the
extension).  Clone of scripts/analysis/pr48/on1k_compare.py.

Usage: python3 on_compare.py [BASE_LABEL NEW_LABEL]

...
# doc 78 round 2: ClusteringExamineBundles busy-cluster lazy walk (the
# 'relaxed_fast' graph flavor).  OFF in the config; SBND_EB_FAST=1 turns it on.
EB_FAST="${SBND_EB_FAST:-}"

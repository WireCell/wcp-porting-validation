...
- PASS 2 (doc 125 sec 9, same day): sec 6 block EXECUTED by the session (sweep 15.41 GiB, file level 90.89 GiB, orphan logs 0, dedup 3.28 GiB); cold pins ARCHIVED to `~/tmp/pin-archive-20260925/` (53 pins, 33.04 GiB; `restore_pins_20260925.sh`); kept-arm logs/configs zstd'd (41983 files, 10.49 -> 1.22 GiB; `uncompress_logs_20260925.sh`); sentinels re-baselined on production (`scripts/analysis/d125/sentinels_prod.py`, 13/0/10/7/0; the 8 d123 FAILs = the doc-118 tfull cost, owner: OPEN) and `work-*-pr150s0` RELEASED (stamp 20260925b, 9.78 GiB; records `archive/records/cleanup-20260925b/`).
- NEW, KEEP: `work-sent150-{mcp1k,mcp2k,ncpi0,nuecc48}` -- the pr150s0 sentinel witness (27 events, 164 MB, 21/0/2/7 == pr150s0), PROTECTED.

#!/usr/bin/env python3
"""Shared drawing helpers for the PDVD NF and SP algorithm diagrams.

Duplication-fork of pdhd/pics/diagram_helpers.py (adds stack_box + the
enlarged review-round font defaults).  pdvd/pics/diagram_helpers.py is kept
untouched so the existing PD-VD clus/imaging builders render byte-identically.

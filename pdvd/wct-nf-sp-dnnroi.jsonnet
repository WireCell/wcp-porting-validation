// PDVD noise filtering + signal processing with DNN-ROI -- THIN RE-EXPORT.
//
// The implementation now lives in the canonical, in-tree job
//   cfg/pgrapher/experiment/protodunevd/wct-nf-sp-dnnroi.jsonnet
...
// run_pr_evt.sh / run_clus_evt.sh `cd` into pdvd/ and name this file bare, and
...
import 'pgrapher/experiment/protodunevd/wct-nf-sp-dnnroi.jsonnet'

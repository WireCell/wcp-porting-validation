// PDVD per-event pattern-recognition job (545 TLA defaults = the PDVD operating point) -- THIN RE-EXPORT.
//
...
import 'pgrapher/experiment/protodunevd/wct-pr-perevt.jsonnet'

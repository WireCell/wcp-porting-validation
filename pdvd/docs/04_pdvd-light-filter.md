...
Milestone 2 of the light-reconstruction plan (`02_light-reco-plan.md` §3): fix the software
...
> records). Figures: `docs/pics/filter_scan.png`, `docs/pics/filter_noise_psd.png`,
> `docs/pics/filter_wi.png`. Companion: `03_pdvd-spe-template.md` (templates, normalization).

#!/bin/bash
# doc pdvd/103 sec 10: blind shots of every scannable item of a NAMED round dir, display arm by arm
# (fork of 103_shoot_all.sh, which is untouched and hard-codes round_<det>).
#   bash 103_shoot_round.sh DET ROUND_NAME [NPROC]     e.g.  bash 103_shoot_round.sh pdvd round_pdvd2 3
set -u

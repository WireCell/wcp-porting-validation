# Your task: a verdict-blind hand scan of PDVD items (doc pdvd/103)
...
`/home/xqian/tmp/d103/round_pdvd/RUBRIC.md`
...
1. **Read only**: the rubric, this file, your item list, and `<SHOTS>/<event>_<cluster>/` for **your own** items.
   ...
   * Under `/home/xqian/tmp/`, open nothing except, inside `/home/xqian/tmp/d103/round_pdvd/`: `RUBRIC.md`, this
     file, `shots/`, your item list, your own out dir and your own scratch dir. Do not list
     `/home/xqian/tmp/d103/` or `/home/xqian/tmp/d103/round_pdvd/` themselves.
...
* `<SHOTS>` = `/home/xqian/tmp/d103/round_pdvd/shots`

...
[06_nf_sp_workflow.md](06_nf_sp_workflow.md). For NF see [nf.md](05_nf.md).
...
- [nf.md §Step 0](05_nf.md) — Resampler overview inside the NF doc
- [06_nf_sp_workflow.md](06_nf_sp_workflow.md) — full pipeline overview

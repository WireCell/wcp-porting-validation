...
This document is mirrored at `pdhd/docs/08_nf_comparison_pdhd_pdvd.md` and
`pdvd/docs/08_nf_comparison_pdhd_pdvd.md`. For per-detector detail see
[`pdhd/docs/nf.md`](../../../pdhd/docs/nf.md) and
[`pdvd/docs/nf.md`](05_nf.md).

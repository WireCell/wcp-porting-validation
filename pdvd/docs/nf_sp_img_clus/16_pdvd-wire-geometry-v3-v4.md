...
> per-anode blob-count recovery. See `17_pdvd-uvw-wire-offset-calibration.md` (built with
...
- **First-wire offset (Z position of U[0]/V[0] vs W[0]).** The first U/V wire
  ...
  **v4** (mm, along +Z; shown as `v3 → v4`):
  ...
  > [`17_pdvd-uvw-wire-offset-calibration.md`](17_pdvd-uvw-wire-offset-calibration.md),

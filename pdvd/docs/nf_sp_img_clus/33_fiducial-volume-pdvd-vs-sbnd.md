...
2. **The CRP y seam is real but far wider than the geometry says** — 0.02 cm of
   ...
   **[Corrected by doc 35 §3.2: these profiles are binned finer than the ctpc
...
**[Corrected by doc 35 §5, which ran the arm instead of modelling it. Dropping
...
signal, not noise: doc 35's repeat arm is bit-identical to its base on all
...
**[Superseded by doc 35 §4: `m_cathode_fv` is read at `QLMatching.cxx:5149`

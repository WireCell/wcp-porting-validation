#!/usr/bin/env python3
"""doc pdvd/102 P4 -- FORK BY DUPLICATION of d101_sim_fit_eval.py (untouched), run numbers 900103/900104.
...
Usage:
  d102_sim_fit_eval.py --det pdvd --arm d102b [--truth /home/xqian/tmp/d102/sim/truth_pdvd.json] --out FILE.tsv
"""
...
RUN = {"pdvd": 900103, "pdhd": 900104}   # doc pdvd/102: the near-isochronous set
...
def main():
    ...
    a = ap.parse_args()
    truth = json.load(open(a.truth or f"/home/xqian/tmp/d102/sim/truth_{a.det}.json"))
    evs = truth["events"]

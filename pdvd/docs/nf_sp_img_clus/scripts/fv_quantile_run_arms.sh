...
declare -A TLA
TLA[d43p80c3]="-S curved_fv=true -A curved_fv_profile=p80"
TLA[d43p90c3]="-S curved_fv=true -A curved_fv_profile=p90"
TLA[d43p90c5]="-S curved_fv=true -A curved_fv_profile=p90 -S curved_fv_margin_y=5 -S curved_fv_margin_z=5"
...
echo "staged $n events x 3 tags"
cd "$PDVD" || exit 1
export PDVD_MAX_JOBS=10
arm () {
    local t=$1
...
arm d43p80c3 & arm d43p90c3 & arm d43p90c5 &
wait

...
def audit(lines, det, own, rname=None):
    ...
    for line in lines:
        ...
        for c in content:
            ...
            probe = re.sub(r'cd /home/xqian/tmp/d103/%s/?\s*&&' % re.escape(rn), '', inp)
...
if sys.argv[1:] == ["--selftest"]:
    ...
    R2 = "/home/xqian/tmp/d103/round_pdvd2"          # sec 10: a named round dir (4th argument)
    ...
    bad2 = [tu({"command": "cat /home/xqian/tmp/d103/round_pdvd/RUBRIC.md"}), tu({"command": f"ls {R2}"}),
            tu({"command": "cat /home/xqian/tmp/p100/carry_r2/latest_on_p99rwon_corrected.json"}),
            tu({"command": "cat /home/xqian/tmp/d103/own/set_pdhd_smx27/manifest.txt"}),
            tu({"command": f"cat {R2}/set/sheet_d103v1.txt"}), tu({"command": "ls /home/xqian/tmp/d103/pdvd_prod"}),

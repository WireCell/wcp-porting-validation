...
Milestone 1 of the light-reconstruction plan (`02_light-reco-plan.md` §4): determine the
...
> Figures: `pdvd/docs/pics/` — `pd_ch<CCCC>.png` (one per DAPHNE channel: template |
...
> `spe_cathode_longtail.png`.  Per-channel numbers: `pdvd/docs/scripts/spe_summary.json`.

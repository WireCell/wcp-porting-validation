...
`10_pdvd-ql-pending.md` (blocked-work checklist), `09_pdvd-qlmatching.md`,
`03_pdvd-spe-template.md`, `08_pdvd-photon-model.md`, `06_pdvd-light-chain.md`.
...
(`10_pdvd-ql-pending.md` §1). Sub-answers, for the record:

**How it was dealt with on our side (full record `10_pdvd-ql-pending.md` §1):**
...
by 1-PE **area**, not amplitude). Details: `03_pdvd-spe-template.md` §5.
...
1. **DAPHNE↔module pairing of the Arapucas** — jjo's DAPHNE→module
   ...
   data (open item, `08_pdvd-photon-model.md` §2: v4 geometry had the Arapucas

...
as-built GDML). Companion docs: `11_pdvd-questions-dune.md` (open DUNE asks,
incl. the uncoated-PMT and gain-calibration items below), `09_pdvd-qlmatching.md`,
...
- **ch 32 (uncoated bottom PMT)**: official `PDVD_PDS_Mapping_v04152025`
  ...
  **But data show it responding at 0.55-1.85x its PEN-coated neighbours'
  ...
  (`11_pdvd-questions-dune.md` §3); unmask if/when an official nonzero 175 nm
...
- **ch 13 (membrane XA, no WLS)** and **ch 29/39 (PEN+Q bottom PMTs)**:
  ...
  part of what confirmed the Xe/175nm library switch (`11_pdvd-questions-dune.md`
  §3); now unmasked/live.
...
- The relative PMT-vs-XA (and even cathode-vs-membrane XA) normalization
  ...
  Xe/175nm libraries (`11_pdvd-questions-dune.md` §2). Absolute cross-type

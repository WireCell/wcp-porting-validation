...
PDHD counterpart of `02_pdvd-anode-time-consistency.md` (same directory), asking
...
python3 scripts/check_anode_time_consistency_pdhd.py     # all checks (A, A', B', C, D, E)
```
...
`02_pdvd-anode-time-consistency.md` §2.3.1.
...
- `pdvd/docs/qlmatch/02_pdvd-anode-time-consistency.md` — the PDVD counterpart

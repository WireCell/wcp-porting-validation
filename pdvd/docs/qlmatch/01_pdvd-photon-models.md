...
underlying investigation doc is `pdvd/docs/08_pdvd-photon-model.md` (2026-07-09).
...
the cfg comments). Detail: `11_pdvd-questions-dune.md` §3,
...
- `pdvd/docs/08_pdvd-photon-model.md` — the original investigation (2026-07-09):
  full geometry cross-matching, ANN/voxel-library consistency numbers,
  reproduction commands.
- `../09_pdvd-qlmatching.md` — QLMatching chain design and knob rationale
  (offset calibration, QtoL history, PE-scale studies).
- `../11_pdvd-questions-dune.md` §3 — the Ar/Xe data-verdict tests in full.

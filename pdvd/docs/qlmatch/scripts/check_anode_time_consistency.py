...
Companion to 02_pdvd-anode-time-consistency.md (same directory).  Uses the
...
Usage (from this directory):
  python3 scripts/check_anode_time_consistency.py            # all 18 events
  python3 scripts/check_anode_time_consistency.py --raw-top  # skip the top re-basing
"""

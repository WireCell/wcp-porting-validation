...
[bot:34, top:169].  See 06_pdvd-drift-crosser-298651.md.
...
Repro:
    ...
    OMP_NUM_THREADS=4 python3 scripts/crosser_drifttime_298651.py
...
OUTDIR = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "pics")  # scripts/ -> qlmatch/pics

#!/bin/bash
# doc qlmatch/32 (fork of d31_light_arms.sh, logs under p32) -- light reco of the 120 production events (pdvd/stm/events.txt) under one arm.
...
LOGD=/home/xqian/tmp/p32/light$ARM

...
exactly their peak channels.  See 09_pdvd-pd-mapping-investigation.md.

Read-only.  Repro:
    cd /nfs/data/1/xqian/toolkit-dev/wcp-porting-img/pdvd
    python3 docs/qlmatch/scripts/pd_mapping_audit.py            # parts 1-3 (fast)
    python3 docs/qlmatch/scripts/pd_mapping_audit.py --raw      # + parts 4-5 (reads rawwf)
...
PDVD = os.path.dirname(os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__)))))  # scripts/qlmatch/docs/ -> pdvd

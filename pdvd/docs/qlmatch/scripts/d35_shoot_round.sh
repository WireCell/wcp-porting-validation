#!/bin/bash
# doc qlmatch/35 amendment 1 (fork of nf_sp_img_clus/figs/116_shoot_round.sh, untouched; round root /home/xqian/tmp/p35scan): blind shots of every scannable item of a NAMED round dir, display arm by arm

...
`11_pdvd-saturation-recovery.md`); QtoL_new = 0.094 × median.
...
(`10_pdvd-spe-calibration-comparison.md`) — are consistent with the **175 nm
...
the earlier Xe/175 data verdict (`11_pdvd-questions-dune.md` §3) on
...
(`14_pdvd-lightpattern-sp-investigation.md`: unmasked dump prediction, per-flash

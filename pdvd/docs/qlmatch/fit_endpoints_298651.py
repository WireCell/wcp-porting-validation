...
reads.  Companion to crosser_drifttime_298651.py / pdvd-drift-crosser-298651.md.
...
Repro:
  ...
  python3 fit_endpoints_298651.py   # prints the table; writes endpoint_fits_298651.png
"""

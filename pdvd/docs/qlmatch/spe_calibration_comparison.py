...
Repro:
    ...
    (writes spe_calibration_comparison.png + prints the tables quoted in
     pdvd-spe-calibration-comparison.md)
...
# Known-bad OUR templates (pdvd-spe-template.md sec.6): excluded from ratio
...
def main():
    ...
    fig.tight_layout()
    out = os.path.join(HERE, "spe_calibration_comparison.png")
